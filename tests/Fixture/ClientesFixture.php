...
class ClientesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'cpf' => ['type' => 'string', 'length' => 11, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_0900_ai_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'status' => 1,
                'created' => '2021-12-08 13:46:21',
                'modified' => '2021-12-08 13:46:21',
            ],
        ];
        parent::init();
    }
